                              ...
                              onPressed: () async {
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: const Text('Registro deletado!'),
                                      content:
                                          const Text('Ação não pode ser desfeita!'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                await RegistrosTable().update(
                                  data: {
                                    'descricao': _model.descTextController.text,
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: const Text('Mandou bem!'),
                                      content: const Text('Registrado Alterado'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(alertDialogContext),
